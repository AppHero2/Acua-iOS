...
@IBDesignable class VTInputView: UIView,UITextFieldDelegate {
    ...
    private func setup(){
        ...
        textFieldView.tintColor = UIColor.gray
    ...
    private func loadNib() {
        let bundle = Bundle(for: VTInputView.classForCoder())
        bundle.loadNibNamed("VTInputView", owner: self, options: nil)
    }
